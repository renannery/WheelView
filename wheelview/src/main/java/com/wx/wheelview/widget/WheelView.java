...
public class WheelView<T> extends ListView implements IWheelView<T> {
    ...
    public interface OnWheelScrollingListener<T> {
    ...
    private OnWheelScrollingListener<T> mOnWheelScrollingListener;
    ...
    public void setOnWheelScrollingListener(final OnWheelScrollingListener<T> onWheelScrollingListener) {
    ...
    private void refreshCurrentPosition(boolean join) {
        ...
        if (mOnWheelScrollingListener != null) {
            mOnWheelScrollingListener.onItemScrolled();
        }
